...
下面的基准测试程序，会体现 Phalcon 跟传统 PHP 框架相比的性能优势。这些
基准测试程序都已经更新到相应框架的最新正式版，Phalcon 也不例外。
...
我们鼓励开发者克隆我们基准程序使用的测试用例代码。如果你有任何其他优化
手段或建议，请不吝'告诉我们_'。'从 Github 检出代码'_
...
测试过程中为所有框架都打开了 APC_ OPCODE 缓存。出于性能考虑，所有的 Apache 的
mod-rewrite 特性都被禁用了。
